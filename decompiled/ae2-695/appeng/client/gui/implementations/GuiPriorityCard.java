...
public class GuiPriorityCard
extends GuiPriority {
    private final ContainerPriorityCard container;
    private GuiImgButton mode;

    public GuiPriorityCard(InventoryPlayer inventoryPlayer, PriorityCardObject host) {
    ...
    public void initGui() {
        super.initGui();
        this.mode = new GuiImgButton(this.guiLeft - 18, this.guiTop + 8, Settings.PRIORITY_CARD_MODE, PriorityCardMode.EDIT);
