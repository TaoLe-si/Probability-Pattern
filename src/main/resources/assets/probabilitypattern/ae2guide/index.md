...
* <ItemLink id="probabilitypattern:probability_pattern" /> — a pattern that stores one attempt, its success probability and its confidence level
* <ItemLink id="probabilitypattern:probability_pattern_terminal" /> — encodes probability patterns as easily as normal patterns
