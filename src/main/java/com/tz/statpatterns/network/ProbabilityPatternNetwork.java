...
/**
 * Registers the mod's SimpleNetworkWrapper channel.
 */
public final class ProbabilityPatternNetwork
{
	public static final SimpleNetworkWrapper CHANNEL = NetworkRegistry.INSTANCE.newSimpleChannel( "probabilitypattern" );
