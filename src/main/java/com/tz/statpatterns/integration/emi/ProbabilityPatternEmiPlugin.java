...
/**
 * EMI integration for the stat pattern terminal.
 * <p>
...
public class ProbabilityPatternEmiPlugin implements EmiPlugin {
    ...
    public void register(EmiRegistry registry) {
        registry.addRecipeHandler(StatPatternsMenus.STAT_PATTERN_TERMINAL,
        ...
        if (ModList.get().isLoaded("ae2wtlib")) {
            var wirelessType = StatPatternsMenus.WIRELESS_STAT_PATTERN_TERMINAL;
