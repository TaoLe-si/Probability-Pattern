 ...
 */
package com.zincglux.statpatterns.item;
...
/**
 * Item form of the ME Probability Pattern Encoding Terminal part (Spec v2.0 3.3.2).
 * <p>
...
public class ItemProbabilityPatternTerminal extends Item implements IPartItem {
    ...
    public ItemProbabilityPatternTerminal() {
        ...
        this.setUnlocalizedName("statpatterns.probability_pattern_terminal");
        AEApi.instance()
            .partHelper()
    ...
    public void registerIcons(final IIconRegister iconRegister) {
        this.icon = iconRegister.registerIcon("statpatterns:probability_pattern_terminal");
    }
